<div class="row">
	<div class="col-md-12">
		...
		<h1 style="margin-bottom: 10px"><a href="index.php"><u>Auction</u></a></small></h1>
		<hr>

	</div>

	<div class="row clearfix" style="margin-top:40px; font-family:sans-serif; font-weight:50px;">
